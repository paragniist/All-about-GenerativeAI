...
async def generate_text_openai(request: TextGenerationRequest) -> TextGenerationResponse:
    """
    ...
    """ 
    # mock_response = TextGenerationResponse(generated_text="Mock response" + request.prompt)
    # print(f"Generated response: {mock_response.generated_text}")
