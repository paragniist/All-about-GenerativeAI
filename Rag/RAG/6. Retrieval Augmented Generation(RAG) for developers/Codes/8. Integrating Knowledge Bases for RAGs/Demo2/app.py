...
wiki_wiki = wikipediaapi.Wikipedia(language='en', user_agent='RAGDemo/1.0 (bletort@bellsouth.net)')
##############################################################################################################
...
def rag_system(query):
    ...
    domain_data = domain_specific_data.get(query.lower(), None)
    ...
    if combined_data:
        inputs = tokenizer(combined_data, return_tensors="pt", max_length=1024, truncation=True)
